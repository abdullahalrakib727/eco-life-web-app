...
const FeaturedProducts: FC = (): JSX.Element => {
  ...
  return (
    <section className="relative mt-16">
      ...
      {/* overlay */}
      <div className="absolute left-0 -z-20 lg:translate-y-24 lg:translate-x-3 xl:translate-y-16">
        <img
          className="max-w-[150px] lg:max-w-[180px] xl:max-w-[232px] xl:max-h-[273px]"
          src="/left.png"
          alt=""
        />
      </div>
      <div className="absolute right-0 -z-20 lg:-translate-y-5 lg:-translate-x-3 xl:-translate-y-20">
        <img
          className="max-w-[150px] lg:max-w-[180px] xl:max-w-[232px] xl:max-h-[273px]"
          src="/right.png"
          alt=""
